...
Route::group(['middleware' => ['is_active']], function () {
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => ['can:review']], function () {
            ...
            Route::get('/review/publish/{id}', [\App\Http\Controllers\Admin\ReviewController::class, 'publish'])->name('review.publish');
            Route::get('/review/sort/{id}', [App\Http\Controllers\Admin\ReviewController::class, 'sort'])->name('review.sort');
        });
        ...
        Route::group(['middleware' => ['can:website-branch']], function () {
            Route::resource('/branch', App\Http\Controllers\Admin\WebsiteBranchController::class);
            Route::get('/branch/publish/{id}', [\App\Http\Controllers\Admin\WebsiteBranchController::class, 'publish'])->name('branch.publish');
            Route::get('/branch/sort/{id}', [App\Http\Controllers\Admin\WebsiteBranchController::class, 'sort'])->name('branch.sort');
        });
