                                    ...
                                    <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    <label class="form-label">คำถาม</label>
                                                    <input type="text" class="form-control form-control-sm" name="question_en" required>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">คำตอบ</label>
                                                    <textarea class="summernote form-control form-control-sm" name="answer_en" required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
