...
@php $pagename = 'ตั้งค่าเว็บไซต์'; @endphp
...
<div class="contrainer p-2">
    ...
    <form method="POST" action="{{ route('settings.update',['setting' => $website->id]) }}" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-sm-12">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                                @include('admin.settings.website.partials.edit_general')
                            </div>
                            <div class="tab-pane fade" id="images" role="tabpanel" aria-labelledby="images-tab">
                                @include('admin.settings.website.partials.edit_images')
                            </div>
                            <div class="tab-pane fade" id="aboutus" role="tabpanel" aria-labelledby="aboutus-tab">
                                @include('admin.settings.website.partials.edit_aboutus')
                            </div>
                            <div class="tab-pane fade" id="seo" role="tabpanel" aria-labelledby="seo-tab">
                                @include('admin.settings.website.partials.edit_seo')
                            </div>
                        </div>
                    </div>
