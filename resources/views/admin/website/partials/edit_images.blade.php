            ...
            <div class="col-sm-4">
                <div class="mb-3">
                    <div class="text-center">
                        ...
                        <img src="@if($website->getFirstMediaUrl('website_logo')) {{$website->getFirstMediaUrl('website_logo')}} @else {{asset('images/no-image.jpg')}} @endif" id="showimg_logo" height="200" style="max-width: 100%; object-fit: contain;"> <br/>
