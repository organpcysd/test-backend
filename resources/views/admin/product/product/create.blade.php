                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" name="price_promotion">
                                                    </div>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียดย่อย</label>
                                                    <textarea class="form-control form-control-sm" name="short_detail_th"></textarea>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียด</label>
                                                    <textarea class="summernote form-control form-control-sm" name="detail_th"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียดย่อย</label>
                                                    <textarea class="form-control form-control-sm" name="short_detail_en"></textarea>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียด</label>
                                                    <textarea class="summernote form-control form-control-sm" name="detail_en"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
