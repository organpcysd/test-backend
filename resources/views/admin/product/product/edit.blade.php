                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="website" class="form-control form-control-sm" style="display: none;" id="website">
                                                        ...
                                                        @foreach($websites as $item)
                                                            <option value="{{$item->id}}" @if($product->website_id == $item->id) selected @endif>{{$item->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                @endif
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control form-control-sm" name="category" id="category">
                                                                ...
                                                                @foreach ($categories as $item)
                                                                    <option value="{{ $item->id }}" @if($product->product_category_id == $item->id) selected @endif>{{ json_decode($item->title)->th }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control form-control-sm" name="subcategory" id="subcategory">
                                                                <option selected disabled>--- เลือกหมวดหมู่ย่อย ---</option>
                                                                @foreach ($subcategories as $item)
                                                                    <option value="{{ $item->id }}" @if($product->sub_product_category_id == $item->id) selected @endif>{{ json_decode($item->title)->th }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" name="title_th" value="{{ json_decode($product->title)->th }}" required>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 mb-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" name="price_promotion" value="{{ $product->price_promotion }}">
                                                    </div>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียดย่อย</label>
                                                    <textarea class="form-control form-control-sm" name="short_detail_th">{{ json_decode($product->short_detail)->th }}</textarea>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียด</label>
                                                    <textarea class="summernote form-control form-control-sm" name="detail_th">{{ json_decode($product->detail)->th }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    <label class="form-label">ชื่อสินค้า</label>
                                                    <input type="text" class="form-control form-control-sm" name="title_en" value="{{ json_decode($product->title)->en }}">
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียดย่อย</label>
                                                    <textarea class="form-control form-control-sm" name="short_detail_en">{{ json_decode($product->short_detail)->en }}</textarea>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียด</label>
                                                    <textarea class="summernote form-control form-control-sm" name="detail_en">{{ json_decode($product->detail)->en }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
