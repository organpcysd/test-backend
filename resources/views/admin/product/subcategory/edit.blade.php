                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="website" class="form-control form-control-sm" style="display: none;" id="website">
                                                        ...
                                                        @foreach($websites as $item)
                                                            <option value="{{$item->id}}" @if($subcategory->website_id == $item->id) selected @endif>{{$item->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                @endif
                                                <div class="mb-3">
                                                    ...
                                                    <select name="category" class="form-control form-control-sm" required>
                                                        ...
                                                        @foreach($categories as $item)
                                                            <option value="{{$item->id}}" @if($subcategory->product_category_id == $item->id) selected @endif>{{ json_decode($item->title)->th }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" name="title_th" value="{{ json_decode($subcategory->title)->th }}" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    <label class="form-label">ชื่อหมวดหมู่ย่อย</label>
                                                    <input type="text" class="form-control form-control-sm" name="title_en" value="{{ json_decode($subcategory->title)->en }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
