...
@php $pagename = 'แก้ไขบริการของเรา'; @endphp
    ...
    <div class="row">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb" style="background-color: transparent;">
                ...
                <li class="breadcrumb-item"><a href="#" onclick="history.back()" class="text-info">จัดการบริการของเรา</a></li>
                ...
                <div class="row">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" value="{{ $service->website->name }}" readonly>
                                                        <select name="website" class="form-control form-control-sm" style="display: none;">
                                                            ...
                                                            @foreach($websites as $item)
                                                                <option value="{{$item->id}}" @if($service->website_id == $item->id) selected @endif>{{$item->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    @endif
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control form-control-sm" name="title_th" value="{{ json_decode($service->title)->th }}" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียดย่อย</label> <br/>
                                                    <textarea name="short_detail_th" class="form-control form-control-sm">{{ json_decode($service->short_detail)->th }}</textarea>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียด</label> <br/>
                                                    <textarea class="summernote" name="detail_th">{{ json_decode($service->detail)->th }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="mb-3">
                                                    <label class="form-label">หัวข้อ</label>
                                                    <input type="text" class="form-control form-control-sm" name="title_en" value="{{ json_decode($service->title)->en }}">
                                                </div>
                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียดย่อย</label> <br/>
                                                    <textarea name="short_detail_en" class="form-control form-control-sm">{{ json_decode($service->short_detail)->en }}</textarea>
                                                </div>

                                                <div class="mb-3">
                                                    <label class="form-label">รายละเอียด</label> <br/>
                                                    <textarea class="summernote" name="detail_en">{{ json_decode($service->detail)->en }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-sm-4">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control form-control-sm" name="seo_keyword" value="{{ $service->seo_keyword }}"></textarea>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">SEO Description</label>
                            <textarea type="text" class="form-control form-control-sm" name="seo_description" value="{{ $service->seo_description }}"></textarea>
                        </div>
                    </div>
                </div>
